            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-text-secondary text-lg max-w-2xl mx-auto">Vous avez un projet nécessitant une
                        architecture Backend solide ? Discutons des spécifications techniques et construisons ensemble
                        un système fiable.</p>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                    <Card className="bg-gradient-card border-border-light shadow-card">
                        <CardHeader>
                            ...
                            <p className="text-text-secondary">Remplissez les champs ci-dessous. Toutes les demandes
                                sont traitées en priorité et une réponse structurée est garantie.</p>
                        </CardHeader>
                        <CardContent>
                            <AppearOnScroll>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <Textarea name="message" required value={formData.message} onChange={handleChange}
                                              ...
                                              rows={6} className="bg-input border-border-light"/>
                                    <Button type="submit" disabled={isSubmitting} size="lg"
                                        ...
                                        {isSubmitting ? "Traitement en cours..." : <><Send className="mr-2 w-5 h-5"/>Soumettre
                                            le Message</>}
                                    </Button>
                                </form>
                            </AppearOnScroll>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-text-secondary text-lg mb-8">Le contact direct est le bienvenu. La
                                latence de réponse standard est de 24 heures, souvent moins.</p>
                        </div>
                        <AppearOnScroll>
                                    ...
                                    <Card key={index}
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-center gap-4">
                                                <div
                                                    className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform shadow-primary">
                                                ...
                                                <div>
                                                    ...
                                                    {info.link ? <a href={info.link}
                                                                    ...
                                                                    className="text-primary hover:text-primary-glow transition-smooth">{info.value}</a> :
