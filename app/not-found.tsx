  ...
  return (
      <section className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
          <div className="absolute inset-0 z-0">
              <div
                  className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 blur-3xl rounded-full animate-pulse-glow"></div>
              <div
                  className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary-glow/5 blur-3xl rounded-full animate-float delay-1000"></div>
          </div>
          ...
          >
              ...
              <p className="text-lg text-text-secondary mb-8">
                  L'URL demandée n'existe pas ou a été déplacée. Veuillez vérifier l'adresse ou revenir à une section
                  valide du portfolio.
              </p>
              <Link href="/">
                  <Button size="lg"
