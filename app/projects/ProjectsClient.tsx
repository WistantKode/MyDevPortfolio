      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-text-secondary text-lg max-w-2xl mx-auto title1">
            Explorez une sélection de mes travaux, allant des applications web interactives aux systèmes backend robustes, conçus avec un accent sur la performance, la sécurité et la scalabilité.
          </p>
        </div>
