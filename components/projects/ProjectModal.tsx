    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl w-full h-[90vh] p-0 gap-0 overflow-hidden bg-background/95 backdrop-blur-xl border-border/50 shadow-2xl rounded-2xl duration-200">
        <div className="grid lg:grid-cols-12 h-full">
          ...
          {/* LEFT: Gallery & Metadata Section (5 cols) */}
          <div className="lg:col-span-5 h-full bg-muted/5 border-r border-border/50 relative flex flex-col overflow-hidden">
             <div className="flex-1 overflow-y-auto scrollbar-hide p-4 lg:p-6">
               ...
               {/* Rich Metadata Grid (Moved to Left) */}
               <div className="grid grid-cols-2 gap-4 mb-8 p-4 bg-background/50 rounded-xl border border-border/50 shadow-sm">
                  {/* Timeline */}
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {project.tech.map((tech, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-background border border-border/50 text-xs font-medium text-secondary-foreground hover:border-primary/50 transition-colors shadow-sm"
                        >
